...
//    Manifold class methods
	...
	DLLEXPORT void Manifold_pos(HMesh::Manifold* self, int vertex_id, double* pos);

    DLLEXPORT size_t Manifold_no_allocated_vertices(HMesh::Manifold* self);
	DLLEXPORT size_t Manifold_no_polygon_indices(HMesh::Manifold* self);
	...
	DLLEXPORT size_t Manifold_no_vertices(HMesh::Manifold* self);
    DLLEXPORT size_t Manifold_no_faces(HMesh::Manifold* self);
    DLLEXPORT size_t Manifold_no_halfedges(HMesh::Manifold* self);
...
// External functions
    ...
    DLLEXPORT void vertex_normal(const HMesh::Manifold* m_ptr, size_t _v, double* norm);
    ...
    DLLEXPORT void face_normal(const HMesh::Manifold* m_ptr, size_t _f, double* norm);
